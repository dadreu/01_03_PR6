package com.example.singin_drachev;
...
public class MainActivity extends AppCompatActivity {
    ...
    class GetDataUser extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            org.jsoup.nodes.Document doc_b = null;
            try {
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                } else AlertDialog("Авторизация", "Такого логина не существует");
        ...
        class SetDataUser extends AsyncTask<Void, Void, Void> {
            ...
            protected void onPostExecute(Void result) {
                super.onPostExecute(result);
                if (body.length() != 0) {
                    if (body.contains("0")) AlertDialog("Авторизация", "Логин занят");
